...
## ℹ️ Дисклеймер
- Этот репозиторий очередной клон бота автопокупки подарков от bohd4nx. В этой версии бота применен форк, который показывает информацию о статусе бота в телеграм канале который вы укажете. 
