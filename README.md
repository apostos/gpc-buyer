...
## ℹ️ Дисклеймер
- Этот репозиторий очередной клон бота автопокупки новых подарков телеграм от bohd4nx. В этой версии бота применен форк, который показывает информацию о статусе бота в телеграм канале который вы укажете. 
- Этот репозиторий был получен, когда софт распространялся по лицензии MIT. Поэтому каждый имеет право на его распространение и использование. 
- Гайд по настройке вы найдете в закрепленном сообщении на канале: [@Gift_price_check](https://t.me/gift_price_check)
- Телеграм ведет активную борьбу с автопокупкой, поэтому есть все шансы что этот софт не сработает. 

## ℹ️ История работы
- 09.07 Коллекция Снупа - Куплена успешно
- 14.08 День Рождения ТГ - Успешно куплены Прем подарки (в том числе Редо)
- 1.09 День знаний - Скрипт пытался купить подарки, но из-за временного лимита купить их было невозможно. Простые гифты купил бы.
- Вопросы по работе бота задавайте в [нашем чате](https://t.me/giftpricechat)
...
[Gifts]
# Формат: ценовой_диапазон:лимит_тиража x количество:получатели <- важно соблюдать пробелы между символом ' x ', внутри кода происходит сплит по этому набору символов
GIFT_RANGES = 1-1000: 500000 x 1: @user1; 1001-5000: 100000 x 2: @канал
